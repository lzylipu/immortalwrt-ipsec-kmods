...
echo "🔐 Downloading IPsec/XFRM kmod APKs from ${IPSEC_KMOD_REPO}@${IPSEC_KMOD_RELEASE}"
TMPDIR="$(mktemp -d)"
...
echo "✅ IPsec/XFRM kmod APKs ready: $(cat /tmp/ipsec-kmod-packages.env)"
